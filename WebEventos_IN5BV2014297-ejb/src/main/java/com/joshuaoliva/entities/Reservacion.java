...
public class Reservacion implements Serializable {
    ...
    public Reservacion(Integer idreservacion, Date horainicio, Date horafin, String descripcion, int lugarEventoidlugarEvento, int areaIdarea, int eventoIdevento, int cotizacionIdcotizacion, int clienteIdcliente) {
        this.idreservacion = idreservacion;
    ...
    public String toString() {
        return "com.joshuaoliva.entities.Reservacion[ idreservacion=" + idreservacion + " ]";
    }
