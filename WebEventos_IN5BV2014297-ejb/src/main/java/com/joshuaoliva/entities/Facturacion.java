...
@NamedQueries({
    ...
    , @NamedQuery(name = "Facturacion.findByCotizacionIdcotizacion", query = "SELECT f FROM Facturacion f WHERE f.cotizacionIdcotizacion = :cotizacionIdcotizacion")})
public class Facturacion implements Serializable {
    ...
    public Facturacion(Integer idfacturacion, String descripcion, Date nombrefactura, long total, int productosIdproductos, int cotizacionIdcotizacion) {
        this.idfacturacion = idfacturacion;
    ...
    public String toString() {
        return "com.joshuaoliva.entities.Facturacion[ idfacturacion=" + idfacturacion + " ]";
    }
