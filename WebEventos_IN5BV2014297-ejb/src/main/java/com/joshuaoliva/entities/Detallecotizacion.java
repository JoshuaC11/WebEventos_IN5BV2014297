...
@NamedQueries({
    ...
    , @NamedQuery(name = "Detallecotizacion.findByProductosIdproductos", query = "SELECT d FROM Detallecotizacion d WHERE d.productosIdproductos = :productosIdproductos")
...
public class Detallecotizacion implements Serializable {
    ...
    public Detallecotizacion(Integer iddetallecotizacion, String descripcion, String cantidad, String precioventa, int productosIdproductos, int cotizacionIdcotizacion) {
        this.iddetallecotizacion = iddetallecotizacion;
    ...
    public String toString() {
        return "com.joshuaoliva.entities.Detallecotizacion[ iddetallecotizacion=" + iddetallecotizacion + " ]";
    }
